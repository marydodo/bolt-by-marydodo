...
// Alpha Layer
    [0] = LAYOUT(
               ...
               MO(3),    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,               KC_SLSH, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_ENT,
...
// Number and Shifted symbols
    [1] = LAYOUT(
               ...
               CLIP_B,    ALFRED_O,                    KC_NO,  KC_NO,                KC_ENT,     KC_NO,                      KC_NO,   KC_NO, KC_NO
             ),
...
// Shift Layer
    [3] = LAYOUT(
	       KC_GRV,   S(KC_Q), S(KC_W), S(KC_E), S(KC_R), S(KC_T),            S(KC_Y), S(KC_U), S(KC_I), S(KC_O),    S(KC_P),    KC_BSPC,
               ...
               ALFRED_O, S(KC_Z), S(KC_X), S(KC_C), S(KC_V), S(KC_B),            S(QUES), S(KC_N), S(KC_M), S(KC_COMM), S(KC_DOT),  QUES, S(KC_ENT),
               CLIP_B,   KC_LALT, KC_LGUI, KC_NO,                                S(KC_SCLN), KC_NO,                         KC_LEFT,    KC_DOWN,  KC_RGHT
	    ),
...
const rgblight_segment_t* const PROGMEM my_rgb_layers[] = RGBLIGHT_LAYERS_LIST(
    capslock_layer,
    num_layer,    // Overrides caps lock layer
    fnreset_layer,    // Overrides other layers
    shift_layer    // Overrides other layers
);
